...
#define __ACC_I2C_SDA_PORT_CLK_EN() __HAL_RCC_GPIOD_CLK_ENABLE()
#define ACC_I2C_SCL_PORT GPIOD
#define ACC_I2C_SCL_PIN GPIO_PIN_12
#define __ACC_I2C_SCL_PORT_CLK_EN() __HAL_RCC_GPIOD_CLK_ENABLE();

#define ACC_I2C_INSTANCE I2C4
#define ACC_I2C_INSTANCE_CLK_EN() __HAL_RCC_I2C4_CLK_ENABLE()
#define ACC_I2C_INSTANCE_TIMING 0x20404768
